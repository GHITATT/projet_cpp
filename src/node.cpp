...
Node::Node(double x_min, double y_min, double x_max, double y_max, vector<unsigned long> triangles) : _x_min(x_min), _y_min(y_min), _x_max(x_max), _y_max(y_max), _triangles(triangles) {
